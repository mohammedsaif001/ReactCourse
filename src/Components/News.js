...
export class News extends Component {
    ...
    async componentDidMount(){  //Executes after Render
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=8de92e1fb9b4472992bb1ae2c00cc11b&page=1&pageSize=${this.props.pageSize}`;
     ...
     handlePrevClick = async()=>{
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=8de92e1fb9b4472992bb1ae2c00cc11b&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
